...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Notification Popup */}
      {isNotificationOpen && Array.isArray(notificationData) && notificationData.length > 0 && (() => {
  const data = notificationData[0];
  return (
    <div 
    ...
    >
      ...
      <div 
        className={`relative bg-card p-4 rounded-2xl shadow-2xl border border-border/20 max-w-lg w-full m-4 
