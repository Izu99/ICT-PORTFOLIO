    ...
    <>
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            {/* Remove ThemeToggle dropdown, keep only WhatsApp button */}
            <Button 
          ...
          <div className="md:hidden flex items-center gap-2">
            {/* WhatsApp Button only, remove ThemeToggle from mobile navbar */}
            <Button 
              onClick={handleWhatsAppClick}
      ...
      {isMenuOpen && (
        <>
          ...
          <div className="md:hidden fixed inset-0 top-0 bg-background/95 backdrop-blur-md z-[9999] animate-in fade-in">
            {/* Keep top navbar visible above dropdown */}
            <div className="fixed top-0 left-0 right-0 z-[10001] bg-background/90 border-b border-border/20 shadow-sm">
              <div className="container mx-auto px-4 py-4 flex items-center justify-between">
                {/* Logo */}
                <a href="#" className="flex items-center group">
                  <p className="text-purple-200 font-semibold">Prabath Wickramasinghe</p>
                </a>
                {/* WhatsApp and Theme buttons (mobile) */}
                <div className="flex items-center gap-2">
                  ...
                  <button
                    className="text-foreground/80 hover:text-primary transition-colors duration-300 z-[10000] bg-background/90 rounded-full p-2 shadow-md border border-border/30"
            ...
            <div className="container mx-auto px-4 py-20 relative">
              <button
                className="absolute top-4 right-4 text-foreground/80 hover:text-primary transition-colors duration-300 z-[10000] bg-background/80 rounded-full p-2 shadow-md"
                onClick={() => setIsMenuOpen(false)}
                aria-label="Close menu"
              >
                <X size={28} />
              ...
              <nav className="flex flex-col gap-5 mt-8">
                ...
                {/* Removed theme section and buttons from mobile dropdown */}
              </nav>
            </div>
          </div>
        </>
