...
export default function Gallery() {
	...
	return (
		<>
			<Helmet>
				<title>Gallery | Prabath Wickramasinghe ICT Portfolio</title>
				<meta name="description" content="View the gallery of achievements and events from Prabath Wickramasinghe's A/L ICT classes." />
				<meta property="og:title" content="Gallery | Prabath Wickramasinghe ICT Portfolio" />
				<meta property="og:description" content="View the gallery of achievements and events from Prabath Wickramasinghe's A/L ICT classes." />
			...
			<main>
				<section
					id="gallery"
					className="py-20 bg-background relative overflow-hidden gallery-section"
